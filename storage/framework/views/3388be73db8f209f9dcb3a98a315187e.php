...
<div class="content">
    ...
    <!-- FORM -->
    <form id="deletionForm" action="<?php echo e(route('account.deletion.submit')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="form-body">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="full_name" id="full_name"
                        ...
                        value="<?php echo e(auth()->user()->name ?? old('full_name')); ?>"
                        required>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="field-sub" style="color: var(--red-mid)"><?php echo e($message); ?></span>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field-group" id="other_reason_group" style="display:none">
                    ...
                    <textarea name="reason_detail" id="reason_detail"
                        placeholder="Tuliskan alasan penghapusan akun secara singkat..."><?php echo e(old('reason_detail')); ?></textarea>
                    <?php $__errorArgs = ['reason_detail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php if(session('success')): ?>
    window.addEventListener('DOMContentLoaded', () => {
        showSuccess('<?php echo e(session("ticket_number") ?? "DEL-" . date("Y") . "-" . rand(10000,99999)); ?>');
    });
<?php endif; ?>
</script>

</body>
</html><?php /**PATH /Users/ghaninafiansyah/Documents/CODE/COMMAND_CENTER/CilacapSuperAppAdmin/resources/views/request-deletion.blade.php ENDPATH**/ ?>